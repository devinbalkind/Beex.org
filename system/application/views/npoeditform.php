...
if(!$edit) {
	echo "<tr><td colspan=2>".anchor('npo/edit/'.$npo->id.'/1', 'Edit', array('class'=>'editbutton'))."</td></tr>";
}
...
if($npo->logo) {
	echo "<td colspan=2>Current Logo</td></tr>";
	echo "<tr><td colspan=2><img src='".base_url()."media/npos/".$npo->logo."' class='main_image' /></td></tr><tr>";
}
