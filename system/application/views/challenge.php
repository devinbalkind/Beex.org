...
<div id="RightColumn">
	...
	<div id="challengeInfo">
	    <h1 class='awesometitle'><?php if($owner && $this->MItems->amountRaised($item->id) == 0) : echo anchor('challenge/delete/'.$item->id, 'Delete', 'class="small_button float_right" style="margin-left:5px;"'); endif; ?> <?php if($owner) : echo anchor('challenge/editor/'.$item->id.'/edit', 'Edit', 'class="small_button float_right" style="margin-left:5px;"'); echo anchor(current_url().'#JourneyInfo', 'Update', array('class'=>'small_button float_right new_note')); endif; ?><?php echo $item->challenge_title; ?>
	...
	<div id="JourneyInfo" name="JourneyInfo">
				...
				<div id="FeedContent">
					...
					<?php if($this->MItems->noProof($item->id)) : ?>
						<div class="proof_graphic">
							...
							<img src='<?php echo base_url(); ?>images/graphics/proof-bg.png' style="width:88%;" />
