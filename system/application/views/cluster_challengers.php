...
<div id="LeftColumn">
	...
	<div id="help">
    	...
    	<h3 class='help_title' id="start_cluster">Describe Your Cluster</h3>
		
		<div class="help_section" id="section_start_cluster">
	        <p class='help_description'>Reference the help editor below if you're confused by a field.</p>
		...
		<h3 class='help_title' id="challenge_template">Challenge Template</h3>
		...
		<?php if(!$new) : ?>
		<h3 class="help_title" id="cluster_challengers">Cluster Challengers</h3>
		...
		<div class="help_section" id="section_cluster_challengers" style="display:none">
			...
			<img class="top_border block" src="<?php echo base_url(); ?>images/backgrounds/help-column-top.png" />
			<div class="help_column">
				You can match the colors of your widget with other colors around the web (such as your website or brand's colors) by using a color selector tool [xxxx] to find the color's six digit code and inputing it into our color choosers.
				<br><br>
