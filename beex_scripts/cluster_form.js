	...
	$("#NextButton, #challenge_template").click(function() {
		...
		*/
		...
		if(new_cluster && !seen_message) {
			...
			Every challenge in your cluster will share the fields that you fill out in the template. For example: If you fill out the fundraising end date in the challenge template, every challenge in your cluster will automatically have that same end date.<br><br>\
